...
import { Upload, Image as ImageIcon, Link, Check } from 'lucide-react';
...
const ImageManager = ({
  ...
  const handleInsert = () => {
    ...
    // Calculate appropriate styles based on ratio, position, and scale
    ...
    // Generate different HTML based on the desired position
    if (position === "header") {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-hidden animate-fade-in">
        <DialogHeader>
          ...
          <DialogDescription>
            Upload or link an image and customize how it appears in your email
          </DialogDescription>
        </DialogHeader>
